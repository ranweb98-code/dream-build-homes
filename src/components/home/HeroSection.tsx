...
import { ArrowRight, Building2, Users, Award, Sparkles } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-background via-background to-muted">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-gradient-to-br from-primary/20 to-secondary/15 rounded-full blur-3xl animate-pulse" />
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-gradient-to-tr from-secondary/20 to-primary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative container mx-auto px-4 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-2xl">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/10 border border-secondary/20 rounded-full text-secondary text-sm font-medium mb-8 animate-fade-up opacity-0" style={{ animationFillMode: 'forwards' }}>
            ...
            <div className="flex flex-wrap gap-4 mt-10 animate-fade-up opacity-0 stagger-3" style={{ animationFillMode: 'forwards' }}>
              <Link to="/properties">
                <Button size="lg" className="h-14 px-8 text-base gap-2 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25 transition-all duration-300 hover:scale-105 hover:shadow-primary/40">
                  Explore Properties
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
              <Link to="/contact">
                <Button size="lg" variant="outline" className="h-14 px-8 text-base gap-2 border-2 border-secondary/30 text-secondary hover:bg-secondary/10 transition-all duration-300 hover:scale-105">
                  Contact Us
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
            ...
            <div className="flex flex-wrap gap-8 mt-16 animate-fade-up opacity-0 stagger-4" style={{ animationFillMode: 'forwards' }}>
              ...
              <div className="flex items-center gap-3" ref={stat3.ref}>
                <div className="w-12 h-12 bg-gradient-to-br from-primary/15 to-secondary/10 rounded-xl flex items-center justify-center">
          ...
          <div className="hidden lg:block relative">
            <div className="relative animate-fade-up opacity-0 stagger-2" style={{ animationFillMode: 'forwards' }}>
              ...
              {/* Decorative Elements */}
              <div className="absolute -z-10 -top-4 -right-4 w-full h-full border-2 border-secondary/20 rounded-3xl" />
